...
export const AppointmentsToolbar = ({
  ...
  return (
    <div className='flex flex-col md:flex-row md:items-center justify-between gap-4'>
      ...
      <div className='flex items-center gap-2'>
        ...
        {!isToday && (
          <Button
            ...
            size='sm'
            onClick={handleToday}
            className='text-xs text-primary hover:text-primary border border-primary/20 hover:bg-primary/10 rounded-lg px-3 h-8 animate-in fade-in slide-in-from-left-2 duration-200'
          >
            Bugun
          </Button>
        )}
      ...
      {/* Right: Search, Filter, View Toggle */}
      <div className='flex flex-wrap items-center gap-2'>
        <div className='hidden md:flex items-center bg-surface px-3 py-2 rounded-xl border border-white/5 focus-within:border-primary transition-all max-w-lg min-w-[200px]'>
